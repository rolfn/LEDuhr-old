...
SRC += i2clcd/i2clcd.c i2cled/i2cled.c keyscan/keyscan.c rtc/rtc.c

# Hardware related defines
# DCF77
CDEFS = -DDCF77_PIN=PINB -DDCF77_PORT=PORTB -DDCF77_DDR=DDRB -DDCF77=PB0
...
# keyscan, key definition
CDEFS += -DKEY_PIN=PINB -DKEY_PORT=PORTB -DTHEKEY=PB1 -DREPEAT_MASK="(1<<THEKEY)"
CDEFS += -D"KEYSCAN_PERIOD=(1.0 / 64)"
...
CINCS = -I$(HOME)/include/avr -Ii2c -Ii2clcd -Ii2cled -Irtc
